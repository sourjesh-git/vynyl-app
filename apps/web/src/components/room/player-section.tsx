      ...
      <div className="flex flex-col gap-8 md:flex-row items-center md:items-start md:gap-10">
        ...
        <div className="flex-1 w-full flex flex-col justify-between min-h-[256px] text-center md:text-left gap-5">
          <div className="space-y-1">
            ...
            <h2 className="text-2xl sm:text-3.5xl font-bold tracking-tight text-white leading-tight font-canela drop-shadow-sm">
              {playback.title}
            </h2>
            <p className="text-base text-white/75 font-semibold font-satoshi">{playback.artist}</p>
            <p className="text-[11px] text-white/50 mt-1 font-satoshi font-medium tracking-wide">
